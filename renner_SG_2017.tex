...
% figure illustrating conventional and CNN nets
...
Discuss use of Python (Keras, TF).  Discuss use of GPUs.  Develop plan for analysis and procedure for understanding DNNs.\\
Ideas:
- show weights and biases
- show 3 track projections
