...
% figure: general conclusion of interest - SiPMs + 2 CNNS --> reconstruction + classification
...
%\begin{center}
%	\begin{tabular}{|L{1.5 cm}|L{2.5 cm}|L{5.0 cm}|L{3.0 cm}|}
%		\hline
