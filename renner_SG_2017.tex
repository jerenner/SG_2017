...
\begin{center}
	...
	\begin{tabular}{|L{1.2 cm}|L{2.5 cm}|L{8.0 cm}|C{3.0 cm}|}
		...
		\cline{2-4}		
		& \multicolumn{2}{l|}{\emph{i. Total Direct Costs for Personnel (in Euro)}} & 977 250\\
		\cline{2-4}		
		& \multicolumn{2}{l|}{\textbf{Travel}} & 25 000\\
		\cline{2-4}		
		& \multicolumn{2}{l|}{\textbf{Equipment}} & 40 000\\
		\cline{2-4}
		...
		\cline{2-4}		
		& \multicolumn{2}{l|}{\emph{ii. Total Other Direct Costs (in Euro)}} & 65 000\\
		
		\cline{1-4}
		\multicolumn{3}{|l|}{\textbf{A - Total Direct Costs (i + ii)} (in Euro)} & 1 042 250\\
		\cline{1-4}
		\multicolumn{3}{|l|}{\textbf{B - Indirect Costs (overheads)} 25\% of Direct Costs (in Euro)} & 260 563\\
		\cline{1-4}
		\multicolumn{3}{|l|}{\textbf{C1 - Subcontracting Costs} (no overheads) (in Euro)} & 0\\
		\cline{1-4}
		\multicolumn{3}{|l|}{\textbf{C2 - Other Direct Costs with no overheads} (in Euro)} & 0\\
	\cline{1-4}
	\rowcolor{Gray}
	\multicolumn{3}{|l|}{\textbf{Total Estimated Eligible Costs (A + B + C)} (in Euro)} & 1 302 813\\
	\rowcolor{black}
	\cline{1-4}
	\rowcolor{Gray}
	\multicolumn{3}{|l|}{\textbf{Total Requested EU Contribution} (in Euro)} & 1 302 813\\
...
\begin{center}
	\begin{tabular}{||L{14.0 cm}|R{1.2 cm}||}
		\hline
		\hline
		\textbf{Please indicate the duration of the project in months:} & \\
		\hline
		\hline
